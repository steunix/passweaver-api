...
export const EV_ENTITY_ITEMEDATA = 35
...
export const EV_ACTION_LDAPPROVISION = 11
export const EV_ACTION_UPDATE = 20
export const EV_ACTION_READ = 30
export const EV_ACTION_READVIALINKED = 32
...
export const EV_ACTION_PWDREADVIALINKED = 83
export const EV_ACTION_PWDCOPYVIALINKED = 84
...
export const actionDescriptions = {
  ...
  81: 'Password copied',
  82: 'Password changed',
  83: 'Password read via linked item',
  84: 'Password copied via linked item',
...
export const METRICS_ITEMSEDATA_READ = 'itemsedata_read_total'
export const METRICS_ITEMSEDATA_LIST = 'itemsedata_list_total'
export const METRICS_ITEMSEDATA_CREATED = 'itemsedata_created_total'
export const METRICS_ITEMSEDATA_DELETED = 'itemsedata_deleted_total'
